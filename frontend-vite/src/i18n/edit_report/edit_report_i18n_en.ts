export const editReportEN = {
    ...
    report: {
        ...
        issues: {
            ...
            noGameLengthSelected: 'No game length selected',
            ...
            substitutionNoPlayerOnName: 'Missing name for the player coming on in a substitution',
            substitutionNoPlayerOnNumber: 'Missing number for the player coming on:',
            substitutionNoPlayerOffName: 'Missing name for the player going off in a substitution',
            substitutionNoPlayerOffNumber: 'Missing number for the player going off:',
            substitutionNoMinute: 'Missing minute for a substitution',
    ...
    teamSelect: {
        ...
        matchedAlias: 'also known as "{alias}"',
    ...
    gameReport: {
        ...
        substitution: {
            playerOn: 'Player coming on',
            playerOff: 'Player going off',
            minute: 'Minute',
        },
        rule: "Rule",
