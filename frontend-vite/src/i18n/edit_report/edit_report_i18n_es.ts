export const editReportES = {
    ...
    report: {
        ...
        issues: {
            ...
            substitutionNoPlayerOnName: 'Falta nombre del jugador que entra en una sustitución',
            substitutionNoPlayerOnNumber: 'Falta número del jugador que entra:',
            substitutionNoPlayerOffName: 'Falta nombre del jugador que sale en una sustitución',
            substitutionNoPlayerOffNumber: 'Falta número del jugador que sale:',
            substitutionNoMinute: 'Falta el minuto de una sustitución',
    ...
    teamSelect: {
        ...
        matchedAlias: 'también conocido como "{alias}"',
    ...
    gameReport: {
        ...
        substitution: {
            playerOn: 'Jugador que entra',
            playerOff: 'Jugador que sale',
            minute: 'Minuto',
        },
        rule: "Regla",
