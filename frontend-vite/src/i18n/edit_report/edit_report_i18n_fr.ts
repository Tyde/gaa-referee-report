export const editReportFR = {
    ...
    report: {
        ...
        issues: {
            ...
            substitutionNoPlayerOnName: 'Nom manquant pour le joueur entrant lors d\'un remplacement',
            substitutionNoPlayerOnNumber: 'Numéro manquant pour le joueur entrant :',
            substitutionNoPlayerOffName: 'Nom manquant pour le joueur sortant lors d\'un remplacement',
            substitutionNoPlayerOffNumber: 'Numéro manquant pour le joueur sortant :',
            substitutionNoMinute: 'Minute manquante pour un remplacement',
    ...
    gameReport: {
        ...
        editSubstitutions: 'Modifier les remplacements',
        disciplinaryActionTitle: 'Actions disciplinaires pour',
        injuriesTitle: 'Blessures pour',
        substitutionsTitle: 'Remplacements pour',
        player: {
            firstName: 'Prénom',
